...
| `surface/coil-ridges` | Stacked horizontal coil bands left visible in the wall — clear cases only; softer seams and single ridges are described in prose, never tagged | 1699, 1701; 11, 15 |
...
| `color/charcoal` | Near-black charcoal-gray body color as photographed — a color name only, not a material or provenance claim; clear cases only | 3, 8, 11, 14, 15, 19 |
