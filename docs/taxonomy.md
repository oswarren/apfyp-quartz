...
|---|---|---|
| `form/cup` | Small drinking-cup form | all of 2250–2260; 1571, 1574, 1576, 1577, 1578; 2085, 2086, 2088, 2089, 2091, 2092; 19; 1627, 1630; 1657, 1661, 1662, 1665, 1666, 1668, 1669, 1670, 1673, 1674, 1682, 1683, 1684, 1685, 1686; 551, 553, 554, 561 |
| `form/bowl` | Open bowl form | 1580, 1588, 1592, 1593; 1729; 3, 12, 16; 1603, 1604, 1606, 1608, 1609, 1610, 1611, 1622, 1623, 1624, 1625, 1637, 1640; 547, 562, 574, 580, 583, 585, 586, 591, 595, 598, 601, 602, 604, 605, 606, 607, 610, 615, 619 |
...
| `surface/sand-speckled` | Dark sand-like speckling peppered through the visible clay surface — material and cause never asserted (kept distinct from `surface/speckled`, whose members show speckling in or under a glaze) | 541, 542, 543, 544, 545, 547, 548, 561, 562, 564, 573 |
...
| `surface/pale-wash` | Thin pale wash-like coating or mottling over a dark body — material never asserted (use over `surface/glaze-wash`-type names unless the image clearly proves glaze) | 1748, 1763, 1764, 1768, 1769; 1664, 1665 |
...
| `surface/metallic-sheen` | Metallic, pewter-like luster on the surface as photographed — its cause (glaze, salt, ash, firing) never asserted; where a store title names one, it is quoted only | 1692, 1697, 1706; 1718; 1673, 1680 |
...
| `surface/glassy-pools` | Glossy, glass-like pools and drips settled on the crown, rim, or interior as photographed — what melted (glaze, ash, or other) is never asserted; clear cases only (2026-07-11 ruling) | 1660, 1679, 1684; 549, 553 |
...
| `color/charcoal` | Near-black charcoal-gray body color as photographed — a color name only, not a material or provenance claim; clear cases only | 3, 8, 11, 14, 15, 19; 1646; 1686 |
| `mark/painted-number` | Piece number hand-painted on the base in dark pigment | 2250, 2251, 2252, 2253 |
| `mark/incised-number` | Piece number incised/carved into the base clay | 2254, 2255, 2256, 2257, 2258, 2259, 2260; 1571, 1577, 1591; 1697, 1748; 1614, 1615; 1655, 1683; 541–557, 561–569, 571–574, 580–615, 619 (the dish with no base shot excluded) |
